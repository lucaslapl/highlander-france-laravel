    ...
    <div class="footer-grid">
        ...
        <div class="footer-col">
            ...
            <ul>
                ...
                <li><span style="opacity:.5;">Composition 9v9</span></li>
                <li><span style="opacity:.5;">FAQ</span></li>
            </ul>
        </div>
    </div>
    <div class="footer-bottom">
        <p>© 2026 Highlander France. Tous droits réservés. Développé par <a href="https://reconnexion.tf">reconnexion.tf</a></p>
    </div>
</footer>
<style>
.site-footer{max-width:1200px;margin:0 auto;padding:28px 15px 15px}
.footer-quote{margin-bottom:18px;opacity:.9}
.footer-quote p{margin:4px 0}
...
.footer-bottom{border-top:1px solid rgba(255,255,255,.08);padding-top:14px;font-size:.85rem;opacity:.8}
