                                ...
                                <div class="flex align-center gap-10">
                                    ...
                                    <span class="joueurs-name">
                                        ...
                                        @if (!empty($player['franceBadges']['highlander']))
                                            <span class="badge-france badge-france-highlander badge-france--small" title="Équipe de France Highlander">FR HL</span>
                                        @endif
                                        @if (!empty($player['franceBadges']['6v6']))
                                            <span class="badge-france badge-france-6v6 badge-france--small" title="Équipe de France 6v6">FR 6v6</span>
                                        @endif
                                    </span>
                                </div>
                            </td>
